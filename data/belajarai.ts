...
export const belajaraiData = {
  id: {
    ...
    hero: {
      ...
      title: 'Lo Bisa Tetep\\\\nJadi Penonton, Atau\\\\nKuasai AI Sekarang\\\\nDan Jadi Yang\\\\nBayar Gajian.',
      subtitle: 'Ini Bukan Kursus AI Biasa. Ini Survival Kit Karir Lo.',
      ...
      description: 'Dibimbing langsung sama Paijo (oyi77) — kontributor Next.js (⭐127k), trpc (⭐36k), Prisma (⭐41k), Vue.js Core (⭐48k). 10+ tahun coding, 1282 AI skills produksi. Bukan teori doang — praktik beneran yang Lo bisa pake besok.',
      buttons: [
        { text: '🔴 Ambil Platinum Pass Sekarang →', href: '#pricing', primary: true },
        { text: '📚 Lihat Dulu Kurikulumnya', href: '#kurikulum', primary: false },
      ],
      badges: ['✅ Bukti Nyata: 150+ GitHub Repos', '✅ Setup Langsung <5 Menit', '✅ Garansi 7 Hari — Gak Cocok? Kembali 100%'],
    },
    ...
    vision: {
      ...
      items: [
        ...
        { icon: '🤖', title: 'Punya AI Agent Sendiri', desc: 'Bikin AI yg kerja 24/7 buat lo — marketing, content, support, semua otomatis.' },
    ...
    founder: {
      ...
      bio: 'Paijo adalah kontributor open source yang telah berkontribusi ke framework Next.js (⭐127k), trpc (⭐36k), Prisma (⭐41k), dan Vue.js Core (⭐48k). Founder 1ai-skills — repositori AI agent skill terbesar dengan 1282 skill produksi.\n\nKenapa lo harus percaya Paijo? Karena kodenya dipake ribuan developer di seluruh dunia. Bukan trainer yg cuma baca dokumentasi — tapi praktisi beneran yg karyanya lo pake setiap hari.',
      achievements: [
      ...
      items: [
        {
          ...
          desc: 'Otomasi proses bisnis end-to-end pake AI. Dari CRM, inventory, customer support, sampe analytics. Dipake real di BerkahKarya ecosystem — 5 layanan jalan 24/7.',
          badge: '🤖 100% Otomatis',
        },
        {
          icon: '📢',
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: 'This Is Not Just an AI Course. It\'s Your Career Survival Kit.',
      ...
      description: 'Guided directly by Paijo (oyi77) — contributor to Next.js (⭐127k), trpc (⭐36k), Prisma (⭐41k), Vue.js Core (⭐48k). 10+ years coding, 1282 AI skills. Not theory, real practice you can use tomorrow.',
      buttons: [
        { text: '🔴 Get Platinum Pass Now →', href: '#pricing', primary: true },
        { text: '📚 View Curriculum First', href: '#kurikulum', primary: false },
      ],
      badges: ['✅ Proven: 150+ GitHub Repos', '✅ Setup <5 Minutes', '✅ 7 Day Money Back Guarantee'],
    },
    problem: {
    ...
    vision: {
      ...
      items: [
        ...
        { icon: '🤖', title: 'Own AI Agents', desc: '24/7 workers — marketing, content, support, all automated.' },
    ...
    founder: {
      ...
      bio: 'Paijo is an open source contributor to Next.js (⭐127k), trpc (⭐36k), Prisma (⭐41k), and Vue.js Core (⭐48k). Creator of 1ai-skills — the largest AI agent skill repo with 1282 production skills.\n\nWhy trust Paijo? Because his code is used by thousands of developers worldwide. Not a theory teacher — a real practitioner whose work you use every day.',
      achievements: [
        { icon: '⬡', text: 'Next.js (⭐127k) — Dead code removal' },
        { icon: '⚡', text: 'trpc (⭐36k) — 9+ PRs merged, 60%+ test coverage' },
        { icon: '🗄️', text: 'Prisma (⭐41k) — Test comment cleanup' },
