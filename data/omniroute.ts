...
export const omnirouteData = {
  id: {
    meta: { title: 'OmniRoute — 398 Model AI, Rp 75K/bulan Flat. Alternatif OpenRouter | BerkahKarya', description: '398 model AI cuma Rp 75K/bulan. GPT-4, Claude, Gemini, DeepSeek, Llama, Qwen. Auto-failover. Bayar GoPay/OVO/DANA. Support Telegram 24/7.' },
    hero: {
      eyebrow: '🔥 398 MODEL AI · RP 75K/BULAN FLAT · ZERO DOWNTIME',
      title: '398 Model AI.\nRp 75K/bulan Flat.\nAlternatif OpenRouter.',
      description: 'OpenRouter charge Rp 300K/bulan untuk 200 model. OmniRoute kasih 398 model — Rp 75K flat. Semua model. Tanpa batas. Auto-failover built-in.',
      buttons: [
        { text: 'Coba Gratis — 1000 Request →', href: `${WA}?text=Halo%2C%20saya%20mau%20coba%20OmniRoute%20API`, primary: true },
    ...
    problem: {
      ...
      bridge: 'OmniRoute: 398 model, Rp 75K flat, auto-failover, bayar lokal.',
    },
    features: [
      ...
      { icon: '🛡️', title: 'Auto-Failover', desc: 'Provider utama down? OmniRoute otomatis switch ke backup dalam 50ms. Zero downtime. Zero panik.' },
      ...
      { icon: '🔑', title: 'Single API Key', desc: 'Satu key OmniRoute = akses ke semua 398 model. Manage permission per key, per team, per project.' },
...
# ✓ ROUTED → gemini-2.0-flash (98ms, cost: $0.00012)`,
    ...
    faq: {
      title: 'FAQ',
      items: [
        { q: 'Apa bedanya OmniRoute dengan OpenRouter?', a: 'OpenRouter: 200 model, Rp 300K/bulan. OmniRoute: 398 model, Rp 75K/bulan. Kami punya auto-failover built-in, opsi bayar lokal (GoPay/OVO/DANA), dan support Telegram <5 menit. OpenRouter harus kartu kredit dan email support.' },
        { q: 'Apakah compatible dengan kode OpenAI saya yang sudah ada?', a: 'Ya, 100%. OmniRoute pakai format OpenAI API. Cukup ganti base URL dan API key — gak perlu ubah kode lain.' },
        ...
        { q: 'Bagaimana auto-failover bekerja?', a: 'Kalau provider utama return error atau timeout, OmniRoute otomatis retry dengan backup provider dalam 50ms. Anda gak akan lihat error — app Anda tetap online.' },
    ...
    cta: { title: '398 Model. Rp 75K/bulan. Mulai Sekarang.', description: '1000 request gratis. Gak perlu kartu kredit. Setup 2 menit.', button: { text: 'Mulai Gratis Sekarang →', href: WA } },
  },
  en: {
    meta: { title: 'OmniRoute — 398 AI Models, $5/mo Flat. OpenRouter Alternative | BerkahKarya', description: '398 AI models for $5/mo. GPT-4, Claude, Gemini, DeepSeek, Llama, Qwen. Auto-failover. Pay with local payment. Telegram support 24/7.' },
    hero: {
      eyebrow: '🔥 398 AI MODELS · $5/MO FLAT · ZERO DOWNTIME',
      title: '398 AI Models.\n$5/mo Flat.\nOpenRouter Alternative.',
      description: 'OpenRouter charges $20/mo for 200 models. OmniRoute gives you 398 models — $5 flat. All models. No limits. Auto-failover built-in.',
      buttons: [
        { text: 'Try Free — 1000 Requests →', href: `${WA}?text=Hello%2C%20I%20want%20to%20try%20OmniRoute%20API`, primary: true },
    ...
    problem: {
      ...
      bridge: 'OmniRoute: 398 models, $5 flat, auto-failover, local payment.',
    },
    features: [
      ...
      { icon: '🛡️', title: 'Auto-Failover', desc: 'Primary provider down? OmniRoute auto-switches to backup in 50ms. Zero downtime. Zero panic.' },
      ...
      { icon: '🔑', title: 'Single API Key', desc: 'One OmniRoute key = access to all 398 models. Manage permissions per key, per team, per project.' },
...
# ✓ ROUTED → gemini-2.0-flash (98ms, cost: $0.00012)`,
    ...
    faq: {
      title: 'FAQ',
      items: [
        { q: 'How is OmniRoute different from OpenRouter?', a: 'OpenRouter: 200 models, $20/mo. OmniRoute: 398 models, $5/mo. We have auto-failover built-in, local payment options (GoPay/OVO/DANA), and Telegram support <5min. OpenRouter requires credit card and email support.' },
        ...
        { q: 'How does auto-failover work?', a: 'If primary provider returns error or timeout, OmniRoute automatically retries with backup provider in 50ms. You never see the error — your app stays online.' },
    ...
    cta: { title: '398 Models. $5/mo. Start Now.', description: '1000 free requests. No credit card required. 2-minute setup.', button: { text: 'Start Free Now →', href: WA } },
  },
} as const;
