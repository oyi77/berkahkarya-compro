// Character mapping per page for consistent persona placement
export const characters = {
  home: { src: '/characters/vilona.jpg', alt: 'Vilona — AI General Manager' },
  'ai-video-studio': { src: '/characters/vilona-side.jpg', alt: 'Vilona — AI Creative Director' },
